...
namespace gestionstock3
{
    public partial class MDIParent1 : Form
    {
        ...
        {
            // Créer un panel parent pour contenir les PictureBox
            Panel panel = new Panel();
            panel.Dock = DockStyle.Fill;
            panel.BackColor = Color.White;
            this.Controls.Add(panel);

            // Taille des PictureBox
            int pictureBoxWidth = 180;
            int pictureBoxHeight = 180;

            // Calculer les positions pour centrer les PictureBox
            int panelWidth = panel.ClientSize.Width;
            int panelHeight = panel.ClientSize.Height;

            int centerX = (panelWidth - pictureBoxWidth * 3) / 2;  // Centrer trois PictureBox
            int centerY = (panelHeight - pictureBoxHeight) / 2;

            // Créer et configurer le premier PictureBox
            PictureBox pictureBox1 = new PictureBox();
            pictureBox1.Image = Image.FromFile(@"D:\travail\sana\sanaprojet\sana\gestionstock3\Resources\imaage 1.jpg");
            pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox1.Location = new Point(centerX, centerY);
            pictureBox1.Size = new Size(pictureBoxWidth, pictureBoxHeight);

            // Créer et configurer le second PictureBox
            PictureBox pictureBox2 = new PictureBox();
            pictureBox2.Image = Image.FromFile(@"D:\travail\sana\sanaprojet\sana\gestionstock3\Resources\image 2.jpg");
            pictureBox2.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox2.Location = new Point(centerX + pictureBoxWidth, centerY);
            pictureBox2.Size = new Size(pictureBoxWidth, pictureBoxHeight);

            // Créer et configurer le troisième PictureBox
            PictureBox pictureBox3 = new PictureBox();
            pictureBox3.Image = Image.FromFile(@"D:\travail\sana\sanaprojet\sana\gestionstock3\Resources\image 3.jpg");
            pictureBox3.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox3.Location = new Point(centerX + pictureBoxWidth * 2, centerY);
            pictureBox3.Size = new Size(pictureBoxWidth, pictureBoxHeight);

            // Ajouter les PictureBox au panel
            panel.Controls.Add(pictureBox1);
            panel.Controls.Add(pictureBox2);
            panel.Controls.Add(pictureBox3);

            // Gérer le redimensionnement pour maintenir les images centrées
            panel.Resize += (sender, e) =>
            {
                panelWidth = panel.ClientSize.Width;
                panelHeight = panel.ClientSize.Height;

                centerX = (panelWidth - pictureBoxWidth * 3) / 2;
                centerY = (panelHeight - pictureBoxHeight) / 2;
...
public void SupprimerMachine(string codeMachine)
{
    ...
    catch (Exception ex)
    {
        ...
        private void arretsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Arrets arrets = new Arrets();
            arrets.ShowDialog();
        }

        private void listesDePlanificationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Listes_planifications listes_Planifications     = new Listes_planifications();  
            listes_Planifications.ShowDialog();
        }

        private void tRSDesMachinesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            TRSMachines tRSMachines = new TRSMachines();
            tRSMachines.ShowDialog();
        }

        private void ficheTRSToolStripMenuItem_Click(object sender, EventArgs e)
        {
            fichetrs fichetrs = new fichetrs    ();
            fichetrs.ShowDialog();
